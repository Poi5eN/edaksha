...
//     <>
//       {loading && <Spinner />}
//       <div className="bg-[#1f2937] h-screen flex flex-col justify-center items-center">
//         <button
...
//                     <h1 className="text-white sm:text-[10px] md:text-[15px]">
//                       Credentials of Admin user for School demo purpose
//                     </h1>
//                     <h1 className="text-shadow-2xl font-semibold sm:text-[10px] md:text-[15px]">
//                       <span className="text-white">Admin Email: </span>
//                       <span className="text-[#57dbff]">projectdemo@gmail.com</span>
//                     </h1>
//                     <h1 className="text-shadow-2xl font-semibold sm:text-[10px] md:text-[15px]">
//                       <span className="text-white">Password: </span>
//                       <span className="text-[#57dbff]">projectdemo</span>
//                     </h1>
//                   </div>
...
//                         className="text-2xl text-white absolute right-3 top-[10px] cursor-pointer"
//                       >
